...
enum FMSyncTMNames {sdb1_1, sdb5_20, sdb20_20, last};
enum FMAsyncTMNames {adb1_1_1, adb4_4_1, adb4_1_4, last_async};

class Atomics
{
    public:
        Atomics(): count_(0), flag_(false), tm_name_(sip1), async_tm_name_(aip1_0_1), fm_sync_tm_name_(sdb1_1){}
