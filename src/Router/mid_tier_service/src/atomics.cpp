...
enum FMSyncTMNames {sdb1_1, sdb50_20, last_sync};
enum FMAsyncTMNames {last_async};

class Atomics
{
    public:
        Atomics(): count_(0), flag_(false), tm_name_(sip1), fm_sync_tm_name_(sdb1_1), fm_async_tm_name_(last_async){}
