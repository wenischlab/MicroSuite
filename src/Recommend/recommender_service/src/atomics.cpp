...
enum FMSyncTMNames {sdb1_1, sdb20_1, last_sync};
enum FMAsyncTMNames {adb1_1_1, last_async};

class Atomics
{
    public:
        Atomics(): count_(0), flag_(false), tm_name_(sip1), async_tm_name_(aip1_0_1), fm_sync_tm_name_(sdb1_1), fm_async_tm_name_(adb1_1_1){}
